...
public partial class DbCineContext : DbContext
{
    ...
    //public virtual DbSet<PeliculaDTO> PeliculaDTO { get; set; }

    public virtual DbSet<PeliculaSalacine> PeliculaSalacines { get; set; }

    //public virtual DbSet<PeliculaSalacineDTO> PeliculaSalacineDTOs { get; set; }

    public virtual DbSet<SalaCine> SalaCines { get; set; }

    //public virtual DbSet<SalaCineDTO> SalaCineDTO { get; set; }

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Pelicula>(entity =>
        {
            entity.HasKey(e => e.Id_Pelicula).HasName("PK__pelicula__B5017F4DCA88243D");

            entity.ToTable("pelicula");

            entity.Property(e => e.Id_Pelicula)
                .ValueGeneratedNever()
        ...
        //modelBuilder.Entity<PeliculaSalacineDTO>(entity =>
        //{
        //    entity.HasKey(e => e.IdPeliculaSala).HasName("PK__pelicula__39BC477F9E1953FE");
        ...
        {
            entity.HasKey(e => e.Id_Sala).HasName("PK__sala_cin__D18B015B367D9533");

            entity.ToTable("sala_cine");

            entity.Property(e => e.Id_Sala)
                .ValueGeneratedNever()
        ...
        //modelBuilder.Entity<SalaCineDTO>(entity =>
        //{
        //    entity.HasNoKey();
